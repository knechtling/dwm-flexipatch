...
#if BAR_BORDER_PATCH /* This allows the bar border size to be explicitly set separately from borderpx. If left as 0 then it will default to the borderpx value of the monitor and will automatically update with setborderpx. */
